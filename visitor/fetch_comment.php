<?php
    ...
    $connect = new PDO('mysql:host=localhost;dbname=stockbarang', 'root', '');
    ...
    foreach($result as $row){
        ...
        <div class="card card-default mb-4">
            ...
            <div class="card-body" align="right"><button type="button" class="btn btn-primary reply" id="'.$row["comment_id"].'"><i class="fa fa-reply" aria-hidden="true"></i> Reply</button></div>
        </div>
        ';
