...
$date2 = date('l, d F Y');
	...
	<div class="container">
        ...
        '<table border="1" align="center" cellspacing="0" cellpadding="4" width="100%">
                <tr>
                    <th colspan="2">GOOD ISSUE</th>
                </tr>
                <tr>
                    <td>No Ref: '.$data["outgoing_id"].'</td>
                    <td>Customer: '.$data["customer"].'</td>
                </tr>
                <tr>
                    <td>Time: '.$data["outgoing_date"].'</td>
                    <td>Remarks: '.$data["misc"].'</td>
                </tr>
        </table>';
        ...
        <table border="1" align="center" cellspacing="0" cellpadding="4" width="100%">
            ...
            if ($SQL_QUERY -> num_rows > 0) {
                ...
                $ID_BARANG = explode(",", $data['product_id']);
                $INDEX_ID_BARANG = 0;
                $NAMA_BARANG = explode(",", $data['product_name']);                                                        
                $INDEX_NAMA_BARANG = 0;
                $QUANTITY = explode(",", $data['quantity']);   
                $INDEX_QUANTITY = 0;

                    foreach(explode(",", $data['serial_number']) as $RESULT) {
                    $html .= '
                        <tr>
