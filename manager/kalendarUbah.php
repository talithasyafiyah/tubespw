               ...
               <div class="sidebar_blog_1">
                  <div class="sidebar-header">
                     <div class="logo_section">
                        <a href="dashboardman.php"><img class="logo_icon img-responsive" style="width: auto;" src="images/logo/status.png" alt="#" /></a>
                     </div>
                  </div>
               ...
               <div class="topbar">
                  <nav class="navbar navbar-expand-lg navbar-light">
                     <div class="full">
                        ...
                        <div class="logo_section">
                           <a href="dashboardman.php"><img class="img-responsive" style="width: auto;" src="images/logo/UD. SATU 7AN.png" alt="#" /></a>
                        </div>
                                    ...
                                    <div class="content">
                                        ...
                                        <?php 
                                            if(isset($_POST['btnUbah'])) {
                                                ...
                                                if($koneksi) {
                                                    $sql = "UPDATE kalendar_manager SET kegiatan='$keg', mulai='$mul', selesai='$sel' WHERE id=$no";
                                                    mysqli_query($koneksi, $sql);
                                                    echo "<script>alert('Data Jadwal Kegiatan Berhasil Diubah');location='dashboardman.php';</script>";
                                                    }
