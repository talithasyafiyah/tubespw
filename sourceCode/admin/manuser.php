                                    ...
                                    <table class="table" id="dataTable" style="background-image: url('images/layout_img/pattern_h.png');">
                                       <thead >
                                          <tr>
                                             ...
                                             <th class="text-right align-right font-weight-bold" data-orderable="false">Action</th>
                                             <th class="text-left align-left font-weight-bold" data-orderable="false"></th>
                                          </tr>
                                       </thead>
                                       <tbody>
                                       <?php
                                          ...
                                          foreach ($query as $row) {
                                                echo "<tr>
                                                         ...
                                                         <i class='fa fa-edit'></i></button></form></td>
                                                         
                                                         <td class='text-left align-left'><form onsubmit=\"return confirm ('Are you sure want to delete ".$row['nama']."’s data?');\"method='POST';>
