                                ...
                                <div class="col-md-12">
                                    <div class="content">
                                        ...
                                        <?php 
                                            ...
                                            $id = $_POST['id'];
                                            $query = "SELECT * FROM kalendar_admin WHERE id='$_POST[id]'";
                                        ...
                                        <?php 
                                            if(isset($_POST['btnUbah'])) {
                                                ...
                                                if($koneksi) {
                                                    $sql = "UPDATE kalendar_admin SET kegiatan='$keg', mulai='$mul', selesai='$sel' WHERE id=$no";
                                                    mysqli_query($koneksi, $sql);
                                                    echo "<script>alert('Data Jadwal Kegiatan Berhasil Diubah');location='dashboardadm.php';</script>";
                                                    }
